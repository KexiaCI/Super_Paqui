...
def chatbot_response(user_text: str) -> dict:
    ...
    if clausulas_re.search(text_n):
        return {"tag": "clausulas", "confidence": 1.0, "response": "Aquí te comparto nuestras cláusulas y condiciones de servicio. Para mayor detalle, por favor revisa la imagen adjunta. 📄👇\n\n_(Puedes ver o descargar tu archivo de cláusulas aquí: /static/Clausulas.jpeg)_"}
            ...
            if _ciudades_p:
                return {
                    ...
                    "response": (
                        ...
                        f"Selecciona la ciudad de destino en el menú desplegable para ver las opciones de entrega disponibles. 📦"
                    ),
                    "options": _ciudades_p
                }
